...
const ITEMS: Dictionary = {
	...
	ItemType.DIRT: {
		...
		"name": "Dirt",
		"category": Category.TERRAIN,
		## Darker wheat.glb soil tone (sampled basecolor browns ~0.48/0.31/0.05).
		"color": Color(0.40, 0.26, 0.07),
	...
	ItemType.GRANARY: {
		...
		"offset_y": 0.75,
		"rotatable": true,
		"def_path": "res://data/placeable_items/granary.tres",
	},
	ItemType.BRIDGE: {
		"id": "bridge",
		"name": "Bridge",
		...
		"offset_y": 0.15,
		"rotatable": true,
		"def_path": "res://data/placeable_items/bridge.tres",
	},
	ItemType.LAMPPOST: {
		"id": "lamppost",
		"name": "Lamp Post",
	...
	ItemType.WELL: {
		...
		"offset_y": 0.45,
		"rotatable": true,
		"def_path": "res://data/placeable_items/well.tres",
	},
	ItemType.COW: {
		"id": "cow",
		"name": "Cow",
		"category": Category.ANIMAL,
		"def_path": "res://data/placeable_items/cow.tres",
	...
	ItemType.FLOWER_RED: {
		...
		"dirt_color": Color(0.40, 0.26, 0.07),
	...
	ItemType.GREENHOUSE: {
		...
		"offset_y": 0.55,
		"rotatable": true,
		"def_path": "res://data/placeable_items/greenhouse.tres",
	},
	ItemType.POND: {
		"id": "pond",
		"name": "Pond",
		...
		"size": Vector3(2.8, 0.12, 2.8),
		"offset_y": 0.06,
		"rotatable": true,
		"footprint": Vector2i(4, 4),
		"def_path": "res://data/placeable_items/pond.tres",
	},
	ItemType.FOUNTAIN: {
		"id": "fountain",
		"name": "Fountain",
		...
		"water_color": Color(0.45, 0.75, 0.95, 0.8),
		"size": Vector3(1.8, 0.9, 1.8),
		"offset_y": 0.4,
		"rotatable": true,
		"def_path": "res://data/placeable_items/fountain.tres",
	},
	ItemType.BENCH: {
		"id": "bench",
		"name": "Bench",
		"category": Category.DECOR,
		"color": Color(0.55, 0.38, 0.22),
		"size": Vector3(1.6, 0.7, 0.55),
		"offset_y": 0.35,
		"rotatable": true,
		"def_path": "res://data/placeable_items/bench.tres",
	},
	ItemType.HAY_BALE: {
		"id": "hay_bale",
		"name": "Hay Bale",
		...
		"size": Vector3(1.0, 0.55, 0.85),
		"offset_y": 0.28,
		"rotatable": true,
		"def_path": "res://data/placeable_items/hay_bale.tres",
	},
	ItemType.WIND_WHEEL: {
		"id": "wind_wheel",
		"name": "Wind Wheel",
